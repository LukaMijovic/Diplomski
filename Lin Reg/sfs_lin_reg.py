...
for k in range(6,15):
    ...
    selector = SequentialFeatureSelector(estimator=lin_reg, n_features_to_select=k)
...
selector = SequentialFeatureSelector(estimator=lin_reg, n_features_to_select=k_list[min_index_mae])
selector.fit(features_train, target_train)
...
selector = SequentialFeatureSelector(estimator=lin_reg, n_features_to_select=k_list[min_index_rmse])
selector.fit(features_train, target_train)
