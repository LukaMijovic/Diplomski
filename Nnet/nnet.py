...
nnet = Sequential()
nnet.add(Dense(20, input_dim=features_train.shape[1], activation="relu"))
...
nnet.fit(features_train, target_train, epochs=epochs, batch_size=batch_size, verbose=1)

preds = nnet.predict(features_test)
